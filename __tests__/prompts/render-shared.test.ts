...
describe("matchesSearch", () => {
  test.concurrent("empty query matches any option", () => {
    expect(matchesSearch("", dnsReadOption)).toBe(true);
    expect(matchesSearch("   ", dnsReadOption)).toBe(true);
  });

  test.concurrent("substring match on label and hint", () => {
...
describe("getGuidePrefix", () => {
  test.concurrent("returns empty string when guide is disabled", () => {
    expect(getGuidePrefix(false, "cyan")).toBe("");
    expect(getGuidePrefix(false, "yellow")).toBe("");
  });

  test.concurrent("returns styled bar prefix when guide is enabled", () => {
...
describe("appendBackHint", () => {
  test.concurrent("appends back hint when allowBack is true", () => {
  ...
  test.concurrent("returns unchanged footer when allowBack is false", () => {
