...
- [#149](https://github.com/mynameistito/create-cf-token/pull/149) [`65c7b4d`](https://github.com/mynameistito/create-cf-token/commit/65c7b4d1d93aebd6a7964f12610205cc2a66c07b) Thanks [@mynameistito](https://github.com/mynameistito)! - Restructure the entire `src/` tree from flat monolith files into domain-oriented modules with clear boundaries, deps injection, and `@/` path aliases.
...
- [#142](https://github.com/mynameistito/create-cf-token/pull/142) [`d1ad172`](https://github.com/mynameistito/create-cf-token/commit/d1ad172b9965cf0a4a4a368bf5b08cb12d8a7173) Thanks [@mynameistito](https://github.com/mynameistito)! - Add JSR publishing configuration and refactor public API types for fast-check compliance.
...
- [#152](https://github.com/mynameistito/create-cf-token/pull/152) [`3b882c6`](https://github.com/mynameistito/create-cf-token/commit/3b882c6765d93ee402b9f7fd4f8c09ce47fdb2d4) Thanks [@mynameistito](https://github.com/mynameistito)! - Add comprehensive TSDoc across the public API and internal modules so IDE tooltips, generated docs, and JSR type documentation accurately describe behaviour.
...
- [#144](https://github.com/mynameistito/create-cf-token/pull/144) [`eb6daab`](https://github.com/mynameistito/create-cf-token/commit/eb6daab11c633a87464aa321c7ceb284159a02fa) Thanks [@mynameistito](https://github.com/mynameistito)! - Stop exporting `HELP_TEXT` and `AUTOMATION_HELP_TEXT` from the package entry point.
...
- [#154](https://github.com/mynameistito/create-cf-token/pull/154) [`00442f5`](https://github.com/mynameistito/create-cf-token/commit/00442f5b75275c85899f8b38c6f99ed46c932868) Thanks [@mynameistito](https://github.com/mynameistito)! - Add automated JSR publishing, keep `deno.json` in sync with `package.json`, and align source with Deno’s stricter publish typechecker.
